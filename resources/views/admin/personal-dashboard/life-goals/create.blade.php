                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <div class="card-title mb-0">Add Goal Item</div>
                                <a href="{{ route('admin.personal.life-goals.index') }}"
                                    class="btn btn-outline-secondary">Back</a>
                            </div>
                            <div class="card-body">
                                <form method="POST" action="{{ route('admin.personal.life-goal-items.store') }}"
                                    enctype="multipart/form-data">
                                    @csrf
                                    @include('admin.personal-dashboard.life-goals._form', ['submitLabel' => 'Create'])
                                </form>
                            </div>
                        </div>
                    </div>
