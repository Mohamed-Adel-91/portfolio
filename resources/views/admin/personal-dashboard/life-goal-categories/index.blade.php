                    ...
                    <div class="col-12">
                        <div class="card h-100">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <div class="card-title mb-0">Life Goal Categories</div>
                                <a class="btn btn-primary" href="{{ route('admin.personal.life-goal-categories.create') }}">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="td-actions">
                                                            <a href="{{ route('admin.personal.life-goal-categories.edit', $category) }}"
                                                                class="icon green" data-toggle="tooltip" title="Edit">
                                                                <i class="icon-edit"></i>
                                                            </a>
                                                            <form method="POST"
                                                                action="{{ route('admin.personal.life-goal-categories.destroy', $category) }}"
